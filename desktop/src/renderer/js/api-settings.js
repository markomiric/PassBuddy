...
async function showApiSettingsDialog(
  ...
  return new Promise((resolve) => {
    ...
    // Add temperature information for DeepSeek
    ...
    tempInfoContainer.innerHTML = `
      ...
      <p>DeepSeek's temperature will automatically adjust based on your input:</p>
      <ul>
        <li><strong>Coding/Math:</strong> 0.0 (Precise)</li>
        <li><strong>Data Analysis:</strong> 1.0 (Balanced)</li>
        <li><strong>General:</strong> 1.3 (Varied)</li>
        <li><strong>Translation:</strong> 1.3 (Flexible)</li>
        <li><strong>Creative:</strong> 1.5 (Imaginative)</li>
      </ul>
    `;
    deepseekContent.appendChild(tempInfoContainer);
...
function showModelIndicator(contentType = null, temperature = null) {
  ...
  let indicatorContent = `
    <div class="indicator-content">
      ...
      <span class="indicator-text">Using model: ${modelName}</span>
    </div>
  `;
